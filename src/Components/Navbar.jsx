...
const Navbar = () => {
    return (
        <div className="navbar bg-gray-100  px-5 md:px-25">
            <div className="navbar-start">
                ...
                <Link to='/'><button className="btn btn-ghost text-xl font-bold"> <img className='w-8' src={logo} alt="" />DocTalk</button></Link>
            </div>
